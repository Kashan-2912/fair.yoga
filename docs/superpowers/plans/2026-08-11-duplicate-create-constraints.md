...
- **#196 is not closed by this branch.** Branch 2 closes it. Never write the negated form with the keyword adjacent to the number in a commit or PR body — GitHub's auto-close parser ignores the negation. That is how PR #191 retired issue 113 by accident.
